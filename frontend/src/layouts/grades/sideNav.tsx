...
// TODO: replace with the authenticated user's data
const USER = {
	en: { name: "Ahmed Ali", role: "Lecturer", faculty: "Faculty of Engineering" },
	ar: { name: "أحمد علي", role: "محاضر", faculty: "كلية الهندسة" },
};
...
const SideNav = () => {
	...
	const user = i18n.language === "ar" ? USER.ar : USER.en;
			...
			>
				<div className="m-2 flex items-center gap-3 border-b border-palette-5 px-2 pb-3 pt-1">
					...
					>
						...
						<p className="truncate text-sm">{user.faculty}</p>
					</div>
				</div>
